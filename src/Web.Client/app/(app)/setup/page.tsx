...
export default function SetupPage() {
        ...
        <CardContent className="space-y-3">
          {drafts.map((draft, index) => (
            ...
            <div key={index} className="flex gap-2">
              ...
              <Select
                value={draft.type}
                onValueChange={(v) => setDraft(index, { type: v as AccountType })}
              >
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Split your income</CardTitle>
        <CardDescription>
      ...
      <CardContent className="space-y-3">
        ...
        <Button className="w-full" onClick={saveTemplate} disabled={total !== 100 || pending}>
