...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20260820063227_Add_Account_Display_Order_Icon_Color")]
    partial class Add_Account_Display_Order_Icon_Color
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Adjustments.Adjustment", b =>
                {
                    ...
                    b.HasIndex("AccountId")
                        .HasDatabaseName("ix_adjustments_account_id");
            ...
            modelBuilder.Entity("Domain.Adjustments.Adjustment", b =>
                {
                    b.HasOne("Domain.Accounts.Account", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_adjustments_accounts_account_id");
                    ...
                    b.HasOne("Domain.Users.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_adjustments_users_user_id");
                });
